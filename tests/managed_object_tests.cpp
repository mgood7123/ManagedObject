...
TEST(MPS_alloc, 1) {
    ...
    printf("allocating and pinning 1 million objects\n");
...
class Timer {
    ...
    void end(const char * msg) {
        ...
        ManagedObjTime t = managed_obj_convert_to_time(_end - _start);
        printf("%s %d seconds, %d milliseconds, %d microseconds\n", msg, t.seconds, t.milliseconds, t.microseconds);
    }
};
